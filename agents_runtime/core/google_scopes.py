...
#
# NOTA (16/08/2026): Google Photos foi REMOVIDO — o escopo
# ``photoslibrary.readonly`` exige verificacao de marca em producao e nao
# funciona sem isso. Mantemos apenas Calendar, Gmail, Drive, Tasks e Contacts.
...
#
# NOTA (16/08/2026): ``photoslibrary.readonly`` removido (Google Photos desabilitado).
