...
class TestKeywordFilter:
    # Tests removidos — _filter_relevant_paragraphs foi eliminado (anti-padrao dominio-especifico).
    # O LLM (DeepSeek v4) le 30k tokens e encontra a resposta em qualquer dominio.
    pass
